...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "depends": [
            "/opt/hostedtoolcache/Python/3.8.12/x64/include/python3.8/Python.h",
            "/opt/hostedtoolcache/Python/3.8.12/x64/include/python3.8/pythread.h",
            "srsly/msgpack/buff_converter.h",
            "srsly/msgpack/pack.h"
        ],
        "include_dirs": [
            "srsly/msgpack",
            "/opt/hostedtoolcache/Python/3.8.12/x64/include/python3.8",
            "."
        ],
        "language": "c++",
